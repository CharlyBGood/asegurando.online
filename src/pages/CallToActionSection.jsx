...
const CallToActionSection = () => {
  return (
    <div className="flex-1 p-4 md:p-6 text-blueGray flex flex-col justify-start items-center text-center bg-white/5 rounded-lg border border-blueGray/20 h-full shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div className="flex flex-col justify-start items-center w-full p-4 md:p-6 lg:p-8">
        {/* Title */}
        ...
        {/* Description */}
        <p className="mb-4 md:mb-6 text-base md:text-xl lg:text-2xl max-w-2xl leading-relaxed">
        ...
        <div className="transform hover:scale-105 transition-transform duration-300 mt-auto">
          <CTAButton
            btnText="¡COTIZA YA!"
            href="https://ecommerce.atmseguros.com.ar/"
